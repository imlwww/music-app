interface HouseOutlineVbProps {
  className: string;
}
export function HouseOutlineVb({ className }: HouseOutlineVbProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      focusable="false"
